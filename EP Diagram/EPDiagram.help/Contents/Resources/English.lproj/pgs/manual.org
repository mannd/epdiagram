...
Note that in diagrams with periods, you must click on the mark the period is attached to, not the period itself.
...
Click the plus button to add a new period.  Click the period in the list to edit it.  Swipe left to delete a period.  Click the Edit button to reorder or delete periods.  The order of periods in the list is the same order that periods will appear in on the ladder.
