...
- On starting the app, a welcome screen will appear from which you can select the option to create a new diagram.
** Load an ECG image
- You should at this point have a blank ladder diagram on your screen, with a blank space above.  This is where the ECG image goes.
...
** Take screenshots
- Take screenshots using the *Screenshot* button at the upper right of the screen.
** Settings
...
** File management
- Use the *Open...*, *New*, and *Close Window* menu items in the *File* menu to open a previously created diagram, create a new diagram, or close a diagram window.  Use *Rename Diagram* in the *File* menu to give the diagram a memorable name. 
