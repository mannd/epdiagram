...
- On starting the app, a file selection screen should appear.  To create a new diagram file, click the *New Document* button at the lower left corner of the window.
** Load an ECG image
...
- Rename the diagram (*File | Rename*)
** Take screenshots
...
** File management
- Use the *Open...*, *New*, and *Close Window* menu items in the *File* menu to open a previously created diagram, create a new diagram, or close a diagram window.
