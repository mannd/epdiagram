...
#if DEBUG
fileprivate let testData: [LadderTemplate] = [LadderTemplate.defaultTemplate_A_AV_V(), LadderTemplate.defaultTemplate_SA_A_AVN_V(), LadderTemplate.defaultTemplate_A_AV_V()]
