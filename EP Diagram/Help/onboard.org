...
- Use it to load images for analysis, change settings, and get help!
...
- Afterwards intervals and conduction times will appear on your diagram (make sure these are set to show up in /Settings/).
