...
- All changes are automatically saved.  Click the /Undo/ and /Redo/ toolbar buttons to revert and restore your changes.  Use the /Open.../, /Close Window/, and /New/ menu items in the /File/ menu to open a previously saved diagram, close a diagram, or create a new diagram in a new window.
