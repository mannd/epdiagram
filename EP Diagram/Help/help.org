...
** Edit the diagram
- Tap the *Edit* button to unlock techniques for fine-tuning your diagram.
...
*** Periods
**** What are periods?
In addition to showing paths of conduction, ladder diagrams are useful for indicating the state of cardiac tissue, such as the duration of refractoriness after cells are depolarized, or, similarly, the timing cycles of an electronic pacemaker, such as the lower rate interval.  These various time periods are traditionally indicated as rectangular areas on a ladder diagram, as shown below.

[Fig showing VVI pacer, LRI]
**** Adding/editing periods
**** Copying periods
**** Deleting periods
**** Detailed period preferences
***** Show periods
...
***** Period size
Choose between a large or small rectangle size.
***** Show period border
...
*** Period preferences
The appearance of [[*Periods][periods]] can be fine-tuned, and these preferences are described in detail [[*Detailed period preferences][in this section]].
*** Hide all marks
