...
After calibration, if settings are set to [[*Measurements][show intervals]] and [[*Measurements][show conduction times]], you will now see measurements on the ladder.  These will change "on the fly" as you modify the ladder.  They will remain accurate even when zooming and scrolling the image, or if you rotate the screen.
...
*** Settings
Settings are discussed [[*Settings][below]].
*** Help
View this help file.
*** About
...
** Settings
There are multiple app settings that you can set, as shown below.  
