...
**** Copying periods
You can copy any already created period to selected marks.  First select the marks you want to copy the periods to in Edit mode, then select Periods | Copy periods from the Periods menu.  Select the periods you want to copy to the selected marks as in the screen image below.

#+CAPTION: Copy periodsg
[[./img/edit_period.png]]
